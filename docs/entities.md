...
### Entidad: `Employee` (Filiativo y Laboral)
Separación estructural del `User` para almacenar datos sensibles o puramente laborales sin contaminar la cuenta de acceso.
*   `id`: Integer
*   `user_id`: Integer (Ref: User) - El "Acceso Digital"
*   `school_id`: Integer (Ref: School)
*   `national_id_type`: String (CI, DNI, RUT)
*   `national_id_number`: String
*   `birth_date`: Date
*   `phone`: String
*   `address`: String
*   `employee_code`: String (Código Interno/Legajo)
